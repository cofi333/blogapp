...
export const CREATE_POST_SCHEMA = z.object({
  ...
  title: z
    ...
    .max(30, { message: 'Title must have maximum 30 characters' }),
  content: z
    .string()
    .trim()
    .min(15, { message: 'Content must have at least 15 characters' }),
});
...
export const UPDATE_COMMENT_SCHEMA = z.object({
  ...
  newComment: z
    .string()
    .trim()
    .min(5, { message: 'New comment must have at least 5 characters' }),
});
